...
echo <<<EOT
			...
			$('button#btn-nuevaBebidaCombo').click(function() {
				...
				//desaparezcan
				$("#nuevaBebidaCombo-form").validate().resetForm();
				$("label").removeClass('state-error').removeClass('state-success');
				$("#nuevaBebidaCombo-form").trigger("reset");
			});
...
EOT;
			...
			// echo 'var $establecimientoForm= $("#nuevaBebidaCombo-form").validate({
...
<div class="modal fade" id="nuevaBebidaCombo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title" id="myModalLabel"><i class="fa fa-building fa-lg"></i> Agregar Bebida a <?php echo $combo['Combo']['nombre'];?></h3>
			</div>
			<div class="modal-body">
				<div clas="row">
					<?php echo $this->Form->create('Bebida', array(
							    'inputDefaults' => array(
							        'label' => false,
							        'div' => false
							    ),
							    'id' => 'nuevaBebidaCombo-form',
							    'class' => 'smart-form',
					...
					<fieldset>
						...
						<div class="row">
							<section class="col col-md-12">
								...
								<label class="select">
									<?php	echo $this->Form->input('bebida',array('empty'=>'Seleccione un país','class'=>'select2','selected'=>array('1'),'disabled' => array(''))); ?>
									<i></i> 
								</label>
							</section>
					</fieldset>
