...
var getTipoProductosUrl= <?php echo "'{$this->html->url(array('controller'=>'ingredientes','action'=>'index'))}';" ?>;
...
var breakpointDefinition = {
 ...
 tablaClientes = $('#dt_ingredientes').DataTable({
   	"bProcessing": true,
    "bServerSide": true,
	...
	"preDrawCallback" : function() {
		...
		if (!responsiveHelper_dt_basic) {
			responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#dt_ingredientes'), breakpointDefinition);
		}
	},
