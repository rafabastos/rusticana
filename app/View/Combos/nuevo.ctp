<?php
//BREADCRUMBS
$this->Html->addCrumb('Nuevo Combo', array('controller' => 'Combo', 'action' => 'nuevo'));
...
<fieldset>
	<div class = "row">
		<section class= "col col-md-4">
			...
			<label class="input"> 
				<?php echo $this->Form->input('nombre', array('placeholder'=>'Introduzca nombre del combo'));?>
		    </label>
		</section> 
		<section class= "col col-md-4">
			<label class="label">Cantidad de Invitados</label>
			<label class="input"> 
				<?php echo $this->Form->input('cantidad_personas', array('placeholder'=>'cantidad de invitados para calculo del combo', 'type'=>'number'));?>
		    </label>
		</section> 
	</div>
	<div class = "row">
		<section class= "col col-md-8">
			...
			<label class="textarea textarea-resizable">
				<?php echo $this->Form->input('descripcion', array('rows'=>'3','class'=>'custom-scroll','placeholder'=>'descripcion del combo'));?>
			</label>
		</section>
	</div>
</fieldset>
